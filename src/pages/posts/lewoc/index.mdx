...
summary: 'Rust, Embassy, LoRa. What else did you expect?'
...
Considering the max packet size of 222-bytes with our modulation parameters, this structure allows for 186 bytes of encrypted data per message. More than enough for our use case.
